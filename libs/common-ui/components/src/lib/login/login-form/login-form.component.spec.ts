...
import { LoginFormComponent, STAGE } from './login-form.component';
...
describe('LoginFormComponent', () => {
  ...
  it('should prevent user from going to the next stage if the email is invalid', () => {
    ...
    component.nextStage();
    expect(component.currentStage()).toBe(STAGE.EMAIL);
  });
  ...
  it('should allow user to go to the next stage if the email is valid', () => {
    ...
    component.nextStage();
    expect(component.currentStage()).toBe(STAGE.PASSWORD);
  });

  it('should prevent user from going to the next stage if the password is invalid', () => {
    component.setStage(STAGE.PASSWORD);
